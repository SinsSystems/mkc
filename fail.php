...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="errorContainer" style="padding-top: 45px;">
      <div class="col-sm-12 text-center">
        <h4>ТРАНСАКЦИЈАТА НЕ БЕШЕ УСПЕШНА. ВЕ МОЛИМЕ ОБИДЕТЕ СЕ ПОВТОРНО!</h4>
        <p>*Вашите седишта ке останат во резервација наредните 15 мин. и истите не можат да се изберат во тој период.</p>
