<?php
    ...
    $log->log_message('process_transaction.php: ' . $data);
                    ...
                    if ($dbConnection->db_connect($errorMessage))
                    {
                        ...
                        {   
                            ...
                            if ($ressql)
                            {
                                ...
                                $okUrl = "http://www.mnt.mk/online/success.php";       //URL which client be redirected if authentication is successful
                                $failUrl = "http://www.mnt.mk/online/fail.php";     //URL which client be redirected if authentication is not successful
                                // sins ip                                
                                // $okUrl = "http://sins.dyndns.info:15002/mnt_booking/success.php";       //URL which client be redirected if authentication is successful
                                // $failUrl = "http://sins.dyndns.info:15002/mnt_booking/fail.php";     //URL which client be redirected if authentication is not successful
