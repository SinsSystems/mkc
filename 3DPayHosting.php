...
$clientId = "180050012";			//Merchant Id defined by bank to user
$amount = "9.95";					//Transaction amount
$oid = "";							//Order Id. Must be unique. If left blank, system will generate a unique one.

$okUrl = "http://192.168.0.204/mnt_booking/halkbank/3D%20Pay%20Hosting%20Sample%20Codes/PHP/3DPayHosting/3DPayHostingResultPage.php";		//URL which client be redirected if authentication is successful
$failUrl = "http://192.168.0.204/mnt_booking/halkbank/3D%20Pay%20Hosting%20Sample%20Codes/PHP/3DPayHosting/3DPayHostingResultPage.php";	//URL which client be redirected if authentication is not successful

$rnd = microtime();				//A random number, such as date/time
$currencyVal = "949";			//Currency code, 949 for TL, ISO_4217 standard
$storekey = "123456MK";			//Store key value, defined by bank.
